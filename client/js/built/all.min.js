...
</html>`;return c},p={"":"text/html",html:"text/html",css:"text/css",js:"application/javascript",json:"application/json"};return{fileFromFileName:n,start:function(){d$1.functions.xReadFileStart=function(a){const c=a.target.files;let d,e=g(a.target,c.length);for(d of c){const c=d.type||"",f=d.name;if(i(f))return void l(d).then(function(b){e=g(a.target,b.length), b.forEach(function(a){a.getData(new zip.BlobWriter,function(b){h(e,b,"",a.filename);});});}).catch(function(a){console.log(b.CANNOT_LOAD_ZIP+a,a);});h(e,d,c,f);}}, d$1.functions.removeFile=function(a){const b=d$1.contextFromEvent(a),c=state.files.find(function(a){return a.uiLink===b});yesNoDialog(`Remove "${c.name}" file ?`,"Yes","No, Cancel").then(function(a){a&&(d$1.elements[b].remove(), d$1.forgetContext(b), state.files.splice(state.files.indexOf(c),1));});}, d$1.functions.rememberFileName=function(a){const b=d$1.contextFromEvent(a),c=state.files.find(function(a){return a.uiLink===b});c.name=d$1.variables[d$1.contextFromArray([b,`fileName`])];}, d$1.functions.rememberFileBody=function(a){const b=d$1.contextFromEvent(a),c=state.files.find(function(a){return a.uiLink===b});c.body=d$1.variables[d$1.contextFromArray([b,`fileBody`])];}, d$1.functions.rememberMime=function(a){const b=d$1.contextFromEvent(a),c=state.files.find(function(a){return a.uiLink===b});c.mime=d$1.variables[d$1.contextFromArray([b,`fileMime`])];};let c=0;d$1.functions.addFile=function(){k().then(function(e){const f=state.files,g=[];e.files.forEach(function(e){const{arrayBuffer:h,mime:i,name:j}=e,k=f.find(function(a){return a.name===j});if(k)return void g.push(yesNoDialog(`A file named "${j}" is already loaded. Overwrite old file with the new one ?`,"Yes, overwrite","No, keep old").then(function(a){if(!0===a){const a=k.uiLink;d$1.elements[d$1.contextFromArray([a,`fileBody`])].disabled=!0, d$1.feed(a,{fileBody:b.FILE_LOADED,fileMime:i}), k.body=h;}else if(!1===a);}));const l=a+(c+"");c+=1;const m=d$1.createElement2({tagName:"file-input","data-inside":l,"data-element":l});d$1.feed(l,{fileName:j,fileBody:b.FILE_LOADED,fileMime:i}), d$1.activate(m), d$1.elements[d$1.contextFromArray([l,`fileBody`])].disabled=!0, state.files.push({name:j,body:h,mime:i,uiLink:l}), d$1.elements.filesContainer.appendChild(m);}), Promise.all(g).then(function(){if(e.package&&e.package.packageObject.serverinthebrowser){const a=e.package.packageObject.serverinthebrowser;console.log("serverinthebrowser field detected",a);const b=a.server;if(b){const a=n(b).body;if(a){const b=bytes.stringFromArrayBuffer(a);d$1.feed(`userCode`,b);}}}});}).catch(function(a){d$1.feed(`log`,"Could not load file: "+a);});}, d$1.functions.addFileEmpty=function(){const b=a+(c+"");c+=1;const e=d$1.createElement2({tagName:"file-input","data-inside":b,"data-element":b});d$1.feed(b,{fileName:"",fileBody:"",fileMime:""}), d$1.activate(e), d$1.elements.filesContainer.appendChild(e), state.files.push({name:``,body:``,mime:``,uiLink:b});}, d$1.functions.generateIndex=function(){const b="index.html",e="text/html",f=m(),g=o(f),h=state.files.find(function(a){return a.name===b});if(h)return void yesNoDialog(`"${b}" already exists. Overwrite it ?`,"Yes","No, Cancel").then(function(a){if(a){const a=h.uiLink;d$1.elements[d$1.contextFromArray([a,"fileBody"])].disabled=!1, d$1.feed(a,{fileBody:g,fileMime:e}), h.body=g, h.mime=e;}});const i=a+(c+"");c+=1;const j=d$1.createElement2({tagName:"file-input","data-inside":i,"data-element":i});d$1.feed(i,{fileName:b,fileBody:g,fileMime:e}), d$1.activate(j), d$1.elements.filesContainer.appendChild(j), state.files.push({name:b,body:g,mime:e,uiLink:i});};},contentTypeFromFileName:function(a){const b=a.split("."),c=b[b.length-1];return p[c.toLowerCase()]||"octet/stream"}}}();
