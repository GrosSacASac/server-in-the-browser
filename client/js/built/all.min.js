...
const state={notificationEnabled:!1,localDisplayedName:"",isOnLine:!0};
...
</html>`;return c},s={"":"text/html",html:"text/html",css:"text/css",js:"application/javascript",json:"application/json"};return{ressourceFromRessourceName:q,start:function(){d$1.functions.xReadFileStart=function(a){const b=a.target.files;let c,d=i(a.target,b.length);for(c of b){const b=c.type||"",f=c.name;if(k(f))return void n(c).then(function(b){d=i(a.target,b.length), b.forEach(function(a){a.getData(new zip.BlobWriter,function(b){j(d,b,"",a.filename);});});}).catch(function(a){console.log(e.CANNOT_LOAD_ZIP+a,a);});j(d,c,b,f);}}, d$1.functions.removeRessource=function(a){const c=d$1.contextFromEvent(a);console.log(c), console.log(d$1.variables[d$1.contextFromArray([c,"fileName"])]);const e=d$1.variables[d$1.contextFromArray([c,"fileName"])],f=o(e);yesNoDialog(`Remove "${e}" ressource ?`,"Yes","No, Cancel").then(function(a){a&&(d$1.elements[d$1.contextFromArray([c,"baseEl"])].remove(), delete b[f], d$1.forgetContext(f));});}, d$1.functions.rememberFileName=function(a){const c=d$1.contextFromEvent(a.target);console.log("240",c), console.log("240",d$1.variables[d$1.contextFromArray([c,"fileName"])]);const e=d$1.variables[d$1.contextFromArray([c,"fileName"])],f=o(e);b[f]=e;};let f=0;d$1.functions.addRessource=function(){m().then(function(b){const g=p(),h=[];b.files.forEach(function(b){const{arrayBuffer:i,mime:j,name:k}=b;if(g.includes(k))return void h.push(yesNoDialog(`A ressource named "${k}" is already loaded. Overwrite old ressource with the new one ?`,"Yes, overwrite","No, keep old").then(function(b){if(!0===b){const b=o(k);d$1.variables[b].fileBody=e.FILE_LOADED, d$1.elements[b].fileBody.disabled=!0, a.set(d$1.elements[b].fileBody,i), d$1.variables[b].fileMime=j;}else if(!1===b);}));const l=c+(f+"");f+=1;const m=d$1.createElement2({tagName:"file-input","data-in":l});d$1.variables={[l]:{fileName:k,fileBody:e.FILE_LOADED,fileMime:j}}, d$1.activate(m), d$1.elements[l].fileBody.disabled=!0, a.set(d$1.elements[l].fileBody,i), d$1.elements.ressourcesContainer.appendChild(m), d$1.functions.rememberFileName({dKeys:[l]});}), Promise.all(h).then(function(){if(b.package&&b.package.packageObject.serverinthebrowser){const a=b.package.packageObject.serverinthebrowser;console.log("serverinthebrowser field detected",a);const c=a.server;if(c){const a=q(c).body;if(a){const b=bytes$1.stringFromArrayBuffer(a);d$1.variables.userCode=b;}}}});}).catch(function(a){d$1.variables.log="Could not load file: "+a;});}, d$1.functions.addRessourceEmpty=function(){const a=c+(f+"");f+=1;const b=d$1.createElement2({tagName:"file-input","data-in":a});d$1.variables={[a]:{fileName:"",fileBody:"",fileMime:""}}, d$1.activate(b), d$1.elements.ressourcesContainer.appendChild(b);}, d$1.functions.generateIndex=function(){const b="index.html",e="text/html",g=p(),h=r(g);if(q(b))yesNoDialog(`"${b}" already exists. Overwrite it ?`,"Yes","No, Cancel").then(function(c){if(c){const c=o(b);d$1.variables[c].fileBody=h, d$1.elements[c].fileBody.disabled=!1, d$1.variables[c].fileMime=e, a.delete(d$1.elements[c].fileBody);}});else{const a=c+(f+"");f+=1;const g=d$1.createElement2({tagName:"file-input","data-in":a});d$1.variables={[a]:{fileName:b,fileBody:h,fileMime:e}}, d$1.activate(g), d$1.elements.ressourcesContainer.appendChild(g), d$1.functions.rememberFileName({dKeys:[a]});}};},contentTypeFromRessourceName:function(a){const b=a.split("."),c=b[b.length-1];return s[c.toLowerCase()]||"octet/stream"}}}();
...
window.d=d$1;const ui$1=function(){const a={selectedUserId:""},b={CONNECTING:"Connecting",CONNECTED:"Connected",SELECT:"Select",SELECTED:"Selected",CONNECT_SELECT:"Connect and select",BAD_ID_FORMAT:"The ID didn't match the following requirement. An ID is 4 to 25 characters long, and only etters from a to Z and digits from 0 to 9  are allowed.",ALREADY_TAKEN_REJECTED:"The ID is already taken. Chose another ID.",ID_CHANGE_REQUEST_SENT:"The request to change the ID has been sent. Waiting for an answer.",ID_CHANGE_SUCCESS:"Your ID has been successfully changed."},c=function(a){return!a||"keydown"!==a.type||13===a.keyCode&&!a.shiftKey};let e=function(){},f="",g=[];const h={},i=function(a){const c="user_"+a;a&&d$1.elements[c]&&(d$1.elements[`${c}>connectButton`].disabled=!0, d$1.feed(b.CONNECTING,`${c}>connectButton`), h[a]=1);},j=function(a,c=!0){const e="user_"+a;a&&d$1.elements[e]&&(d$1.elements[`${e}>connectButton`].disabled=c, d$1.elements[`${e}>selectButton`].disabled=!c, d$1.elements[`${e}>selectButton`].hidden=!c, c?(d$1.feed({connectButton:b.CONNECTED,selectButton:b.SELECT},e), h[a]=2):(d$1.elements[`${e}>connectButton`].disabled=!1, d$1.elements[`${e}>selectButton`].disabled=!0, d$1.elements[`${e}>selectButton`].hidden=!0, d$1.feed({connectButton:b.CONNECT_SELECT},e), h[a]=0));},k=function(c,e=!0){2!==h[c]&&(e=!1);const f="user_"+c,g="user_"+a.selectedUserId;e?(a.selectedUserId&&d$1.elements[g]&&(d$1.elements[`${g}>selectButton`].disabled=!1, d$1.feed(b.SELECT,`${g}>selectButton`), d$1.elements[g+"host"].className=""), c&&d$1.elements[f]&&(d$1.elements[`${g}>selectButton`].disabled=!0, d$1.feed(b.SELECTED,`${g}>selectButton`), d$1.elements[f+"host"].className="active"), a.selectedUserId=c, m(c)):c&&d$1.elements[f]&&(d$1.elements[`${g}>selectButton`].disabled=!1, d$1.feed(b.SELECT,`${g}>selectButton`), d$1.elements[f+"host"].className="");},l=function(c){const e=c.map(function(a){return a.displayedName}).filter((a)=>a!==state.localDisplayedName);d$1.elements.connected_users.innerHTML="", g.forEach(function(a){d$1.forgetContext(a);}), g=[], e.map(function(a){const c="user_"+a;g.push(c);const e=d$1.createElement2({tagName:"li",is:"user-item","data-inside":c,"data-element":c+"host"});d$1.feed(a,d$1.contextFromArray([c,"userDisplayName"])), d$1.activate(e), rtc$1.rtcPeerConnectionFromId.has(a)&&rtc$1.isOpenFromDisplayName(a)&&(d$1.elements[c+"host"].className="", d$1.feed(b.CONNECTED,`${c}>connectButton`), d$1.elements[`${c}>connectButton`].disabled=!0, d$1.elements[`${c}>selectButton`].disabled=!1, d$1.elements[`${c}>selectButton`].hidden=!1), 1===h[a]&&i(a), 2===h[a]&&j(a), d$1.elements.connected_users.appendChild(e);}), Object.keys(h).forEach(function(a){e.includes(a)||delete h[a];}), a.selectedUserId&&k(a.selectedUserId);},m=function(a){const b=rtc$1.isOpenFromDisplayName(a),c=rtc$1.connectedUsers.some(function(b){return b.displayedName===a&&b.isServer}),e=!b;d$1.elements.send_button.disabled=e, d$1.elements.input.disabled=e, d$1.elements.indexLink.classList.toggle("disabled",!c);},n=function(a){o(!a), d$1.elements.main.hidden=!a;const b=localData.get("state.localDisplayedName");b&&(d$1.feed(b,`newId`), d$1.functions.idChangeRequest()), d$1.feed("",`log`);},o=function(a=!0){return d$1.elements.landingPage.hidden=!a, d$1.feed("",`log`), new Promise(function(a){e=a;})};let p=function(a){d$1.activate();let b=0;const c=function(a){return{innerHTML:`<a href="${a}" target="_blank" rel="noopener noreferrer">${a}</a>`}};Object.keys(a).forEach(function(e){b+=1;const f="i"+(b+""),g=a[e],h=d$1.createElement2({tagName:"missing-feature","data-in":f});d$1.feed({title:e,text:g.text,links:g.links.map(c)},`iString`), d$1.activate(h), d$1.elements.missingFeatures.appendChild(h);});};const q=[],r=function(a){const b=document.createElement("p");b.textContent=d$1.variables.lastMessage, d$1.elements.allButLastMessages.appendChild(b), q.push(b), d$1.feed(a,`lastMessage`), q.length>50&&q.shift().remove();},s=function(a){d$1.elements.parsingResult.classList.toggle("error",!0), d$1.feed(a,`parsingResult`), d$1.feed(!1,`useCustom`), rtc$1.useHandleRequestCustom(!1);};return Object.assign(a,{start:function(){uiFiles$1.start(), d$1.functions.acceptAndStart=function(){e(), n(!0), localData.set(MESSAGES.CONDITION_ACCEPTED,"true");}, d$1.functions.changeCustom=function(){const a=d$1.variables.useCustom;a&&(d$1.feed(!1,`useCustom`), d$1.feed("Stopped while editing !",`parsingResult`), rtc$1.useHandleRequestCustom(!1), browserServer.close());}, d$1.functions.warnBeforeLeaveChange=function(){console.log(d$1.variables.warnBeforeLeave), localData.set("warnBeforeLeave",d$1.variables.warnBeforeLeave);}, d$1.functions.wantNotificationChange=function(){const a=d$1.variables.wantNotification;let b;a?"Notification"in window?"granted"===Notification.permission?(b="Notifications enabled", state.notificationEnabled=!0, localData.set("notifications",state.notificationEnabled)):(b="Waiting for autorization", d$1.feed(!1,`wantNotification`), Notification.requestPermission(function(a){"granted"===a?(state.notificationEnabled=!0, localData.set("notifications",state.notificationEnabled), d$1.feed("Notifications enabled",`wantNotificationFeedBack`), d$1.feed(state.notificationEnabled,`wantNotification`)):(d$1.feed("Notifications access denied",`wantNotificationFeedBack`), state.notificationEnabled=!1, localData.set("notifications",state.notificationEnabled));})):(b="This browser does not support desktop notification, or this option has been disabled", state.notificationEnabled=!1, localData.set("notifications",notificationEnabled), d$1.feed(notificationEnabled,`wantNotification`)):(b="Notifications disabled", state.notificationEnabled=!1, localData.set("notifications",state.notificationEnabled)), d$1.feed(b,`wantNotificationFeedBack`);}, d$1.functions.useCustom=function(){const a=d$1.variables.useCustom;a?(browserServer.setBrowserServerCode(d$1.variables.userCode), browserServer.run().then(function(){d$1.elements.parsingResult.classList.toggle("error",!1), d$1.feed(state.localDisplayedName,`your_id`), d$1.variables.parsingResult="Successfully parsed", rtc$1.useHandleRequestCustom(!0);}).catch(s)):(browserServer.close(), rtc$1.useHandleRequestCustom(!1));}, d$1.functions.sendMessage=function(b){c(b)&&(rtc$1.sendRtcMessage(a.selectedUserId,d$1.variables.input), r(`You to ${a.selectedUserId}:  ${d$1.variables.input}`), d$1.feed("",`input`), b.preventDefault());}, d$1.functions.connectToUser=function(a){console.log("d.contextFromEvent(event)",d$1.contextFromEvent(a)), console.log("373",d$1.variables[d$1.contextFromArray([d$1.contextFromEvent(a),"userDisplayName"])]);const b=d$1.variables[d$1.contextFromArray([d$1.contextFromEvent(a),"userDisplayName"])];i(b), f=b, rtc$1.startConnectionWith(!0,b);}, d$1.functions.selectUser=function(a){const b=d$1.variables[d$1.contextFromArray([d$1.contextFromEvent(a),"userDisplayName"])];k(b);}, d$1.functions.debug=function(){const b=5;d$1.feed(b,`log`), console.log(b);}, d$1.functions.idChangeRequest=function(a){if(c(a)){const a=/[a-zA-Z0-9]{4,25}/,c=d$1.variables.newId,e=c.length;return a.test(c)?void(sockets.requestIdChange(c), d$1.feed(b.ID_CHANGE_REQUEST_SENT,`idChangeFeedback`), d$1.elements.idChangeRequestButton.disabled=!0, d$1.elements.newId.disabled=!0):void d$1.feed(b.BAD_ID_FORMAT,`idChangeFeedback`)}}, d$1.functions.changeLocalServerAvailability=function(){sockets.socket.emit(MESSAGES.LOCAL_SERVER_STATE,{displayedName:state.localDisplayedName,isServer:d$1.variables.localServerAvailability});}, d$1.functions.deleteAll=function(){yesNoDialog(`Delete all local data and quit ?`,"Yes","No, Cancel").then(function(a){a&&(localData.clearAll(), serviceWorkerManager.deleteServiceWorker(), d$1.feed(!1,`warnBeforeLeave`), caches.keys().then(function(a){return Promise.all(a.map(function(a){return caches.delete(a)}))}).then(function(){location.href+="quit";}));});};const g=function(a){d$1.elements[a].remove(), d$1.forgetContext(a);};p=void 0, d$1.feed({log:"Starting ...",input:"",output:"",newId:"",warnBeforeLeave:localData.getElseDefault("warnBeforeLeave",!1),wantNotification:localData.getElseDefault("notifications",state.notificationEnabled)}), d$1.functions.wantNotificationChange(), d$1.feed({useCustom:!1,your_id:"not yet connected",localServerAvailability:!1,userCode:`const http = require("http");
    ...
    `}), d$1.activate(), g("missingFeatures"), g("missingFeatureTemplate");},updateUserList:l,displayOwnUserId:function(){d$1.feed(state.localDisplayedName,`your_id`);},displayFatalError:function(a,...b){d$1.feed(a,`log`), console.log(a), b&&0<b.length&&console.log(...b);},display:n,displayLandingPage:o,markUserAsConnected:j,markUserAsSelected:k,selectAfterConnected:function(a){f===a&&k(a);},serverLog:function(a){d$1.feed(d$1.variables.serverLog+"\n"+JSON.stringify(a),`serverLog`), console.log(a);},handleMessage:function(a,b){r(`From ${b}:  ${a.body}`);},handleChangeIdResponse:function(c,e){if(c===MESSAGES.USER_ID_CHANGE||c===MESSAGES.CONFIRM_ID_CHANGE){const{newId:g,oldId:i}=e;if(rtc$1.connectedUsers.some(function(a){if(a.displayedName===i)return a.displayedName=g, !0}), c===MESSAGES.CONFIRM_ID_CHANGE)state.localDisplayedName=g, localData.set("state.localDisplayedName",g), d$1.feed({newId:"",your_id:g,idChangeFeedback:b.ID_CHANGE_SUCCESS});else if(c===MESSAGES.USER_ID_CHANGE)return f===i&&(f=g), a.selectedUserId===i&&(a.selectedUserId=g), h[i]&&(h[g]=h[i], delete h[i]), rtc$1.userIdChange(i,g), void l(rtc$1.connectedUsers)}else c===MESSAGES.BAD_ID_FORMAT_REJECTED?d$1.feed(b.BAD_ID_FORMAT,`idChangeFeedback`):c===MESSAGES.ALREADY_TAKEN_REJECTED&&d$1.feed(b.ALREADY_TAKEN_REJECTED,`idChangeFeedback`);d$1.elements.idChangeRequestButton.disabled=!1, d$1.elements.newId.disabled=!1;},displayNonMetRequirement:p,lateReject:s}), a}();

const MAX_NOTIFICATION_TIME=8e3; const launcher=function(){if(!window.test){const a={"Service Worker":{API:navigator.serviceWorker,text:"Service Worker must be enabled. Service Worker cannot be used in private browsing mode.",links:["https://duckduckgo.com/?q=how+to+enable+service+worker"]},WebRTC:{API:window.RTCPeerConnection,text:"WebRTC must be enabled.",links:["https://duckduckgo.com/?q=how+to+enable+webrtc"]}},b=function(a){let b=!1;const c={};return Object.keys(a).forEach(function(d){a[d].API||(b=!0, c[d]=a[d]);}), !!b&&c}(a);if(b)return void ui$1.displayNonMetRequirement(b);ui$1.start();const c=function(){serviceWorkerManager.start(), sockets.start(), window.addEventListener("beforeunload",function(a){if(d$1.variables.warnBeforeLeave){const b="Are you sure you want to leave ?";return a.returnValue=b, b}},!1), window.addEventListener("unload",function(){sockets.socket.emit(MESSAGES.EXIT,{});},!1);const a=function(){if(!state.notificationEnabled)return;state.isOnLine=navigator.onLine;let a=state.isOnLine?"Connected to the network":"Not connected to the network";const b=new Notification("Online Status",{body:a,tag:"onLine",noscreen:!0});setTimeout(b.close.bind(b),MAX_NOTIFICATION_TIME);};window.addEventListener("online",a), window.addEventListener("offline",a);};c(), ui$1.display(!0);}};

"http:"===location.protocol&&"http://localhost:8080/"!==location.href&&(location.href="https"+location.href.slice(4));const startErrorElement=document.getElementById("starterror");startErrorElement&&startErrorElement.remove(), window.test=window.test||!1, requestAnimationFrame(launcher);
